...
from app.api import auth, employees, shifts, schedules, requests, wards, compliance, preferences, roles
...
app.include_router(compliance.router, prefix="/api/compliance", tags=["Compliance & Rules"])
